...
export function GasIcon({ className }) {
  return (
    <svg
      className={className}
      viewBox="0 0 24 24"
      ...
      aria-hidden="true"
    >
      <path d="M7 16a4 4 0 0 1 0-8 5 5 0 0 1 9.5-1.5A4 4 0 0 1 19 14" />
      <path d="M6 16h12" />
    </svg>
  );
}

export function ShockIcon({ className }) {
  return (
    <svg
      className={className}
      viewBox="0 0 24 24"
...
export function GpsIcon({ className }) {
  return (
    <svg
      ...
      aria-hidden="true"
    >
      <path d="M12 21s6-6.6 6-11a6 6 0 1 0-12 0c0 4.4 6 11 6 11Z" />
